...
def run_query(url, name):
    ...
    for product in product_list_items:
        ...
        if(product.find('div', class_='jsx-837743620 price AdElements__ItemPrice--container-L2hvbWUv') is not None):
            tmp = product.find('div', class_='jsx-837743620 price AdElements__ItemPrice--container-L2hvbWUv').find('h6').contents
            price = ''.join(tmp)
